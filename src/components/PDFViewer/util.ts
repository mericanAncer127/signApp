...
import {
  drawRect,
  drawImage,
  clearSignToolPosition,
  getSignToolPositon,
} from "../../util/canvasTool";
...
// 获取当前canvas，里边包含初始帧
export const getCurCanvasInitImageData = (
  canvas: HTMLCanvasElement,
  imageDataList: InitCanvasImageData[]
): InitCanvasImageData => {
